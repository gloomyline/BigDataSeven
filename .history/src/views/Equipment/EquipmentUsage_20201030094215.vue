      ...
      var option = {
        ...
        tooltip: {
          ...
          formatter:function(params){
            ...
            return `起重机租赁价格：${qidongji[params[0].dataIndex]}<br />起重机公司限价：${qiCompanyPrice}<br />起重机集团限价：${qiGroupPrice}<br />挖掘机租赁价格：${wajueji[params[0].dataIndex]}<br />挖掘机公司限价：${wajiCompanyPrice1}<br />挖掘机公司限价：${wajiGroupPrice1}<br />`
          }
