...
export default {
  ...
  methods:{
    async initData(){
      ...
      this.wajiGroupPrice2=res.wajiGroupPrice
    ...
    echarts(id, xData, seriesData, yTitle, projectIdArr) {
      ...
      var _that = this;
      var option = {
        color: ["#0fc1d6","#E41110", "#e46c11", "#1188e4", "#11E46c", "orange","#f57A82"],
        legend:{
          show:true,
          textStyle:{
            color:"#fff"
