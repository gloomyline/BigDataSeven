...
export default {
  ...
  methods:{
    async initData(){
      ...
      this.qizhongjiMean=res.qizhongjiMean
      this.wajuejiMean=res.wajuejiMean
    ...
    price(data){
      ...
      var seriesData = [
        ...
        },
        {
          ...
          markLine: {
              ...
              label: {
                position: "end",
                formatter: `汽车起重机公司限价${this.qiCompanyPrice}`,
              },
              data: [
                {
        ...
        },
        {
          ...
          markLine: {
              ...
              label: {
                position: "end",
                formatter: `汽车起重机集团限价${this.qiGroupPrice}`,
              },
              data: [
                {
                  silent: false, //鼠标悬停事件  true没有，false有
        ...
        },
        {
          ...
          markLine: {
              ...
              label: {
                position: "end",
                formatter: `挖掘机公司限价${this.wajiCompanyPrice1}`,
              },
              data: [
                {
                  silent: false, //鼠标悬停事件  true没有，false有
        ...
        },
        {
          ...
          markLine: {
              ...
              label: {
                position: "end",
                formatter: `挖掘机集团限价${this.wajiGroupPrice1}`,
              },
              data: [
                {
                  silent: false, //鼠标悬停事件  true没有，false有
      ...
      this.echarts2("price", xData, seriesData, '单位(万元)',qizhongji,wajueji,this.qiCompanyPrice,this.qiGroupPrice,this.wajiCompanyPrice1,this.wajiGroupPrice1)
    },
    usingRate(data){
    ...
    expendRate(data){
              ...
              data: [
                {
                  ...
                  // yAxis: this.qizhongjiMean, // 警戒线的标注值，可以有多个yAxis,多条警示线   或者采用   {type : 'average', name: '平均值'}，type值有  max  min  average，分为最大，最小，平均值
                  yAxis:3.5
                },
              ],
            },
              ...
              data: [
                {
                  ...
                  yAxis: this.wajuejiMean, // 警戒线的标注值，可以有多个yAxis,多条警示线   或者采用   {type : 'average', name: '平均值'}，type值有  max  min  average，分为最大，最小，平均值
                },
              ],
            },
          label: {
      ...
      this.echarts3("expendRate", xData, seriesData, '单位(L/H)')
    },
    echarts(id, xData, seriesData, yTitle, projectIdArr) {
      var myChart = echarts.init(document.getElementById(id));
      var _that = this;
      var option = {
        color: ["#ff6600","#ffff33", "#33cc33"],
        legend:{
          show:true,
          textStyle:{
            color:"#fff"
    ...
    echarts2(id, xData, seriesData, yTitle,qidongji,wajueji,qiCompanyPrice,qiGroupPrice,wajiCompanyPrice1,wajiGroupPrice1) {
      var myChart = echarts.init(document.getElementById(id));
      var _that = this;
      var option = {
        color: ["#0af","red", "DeepPink", "DarkOrange", "Cyan", "Salmon"],
        legend:{
          show:true,
          data:["汽车起重机租赁价格","挖掘机租赁价格"],
          textStyle:{
            color:"#fff"
          }
        ...
        tooltip: {
          ...
          formatter:function(params){
            ...
            return `起重机租赁价格：${qidongji[params[0].dataIndex]}<br />
            起重机公司限价：${qiCompanyPrice}<br />
            起重机集团限价：${qiGroupPrice}<br />
            挖掘机租赁价格：${wajueji[params[0].dataIndex]}<br />
            挖掘机公司限价：${wajiCompanyPrice1}<br />
            挖掘机公司限价：${wajiGroupPrice1}<br />`
          }
    ...
    echarts3(id, xData, seriesData, yTitle, projectIdArr) {
      var myChart = echarts.init(document.getElementById(id));
      var _that = this;
      var option = {
        color: ["#ffff33", "#00ccff"],
