...
export default {
  ...
  methods:{
    ...
    price(data){
      ...
      this.echarts2("price", xData, seriesData, '单位(万元)',wajueji,qizhongji,this.qiCompanyPrice,this.qiGroupPrice)
    },
    usingRate(data){
    ...
    echarts2(id, xData, seriesData, yTitle,qidongji,wajueji,qiCompanyPrice,qiGroupPrice) {
      var myChart = echarts.init(document.getElementById(id));
      var _that = this;
      var option = {
        color: ["LightPink","red", "DeepPink", "DarkOrange", "Cyan", "Salmon"],
