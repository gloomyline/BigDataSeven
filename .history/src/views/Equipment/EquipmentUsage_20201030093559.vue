...
export default {
  ...
  methods:{
    ...
    price(data){
      ...
      this.echarts2("price", xData, seriesData, '单位(万元)',wajueji,qizhongji,this.qiCompanyPrice,this.qiGroupPrice,this.wajiCompanyPrice1,this.wajiGroupPrice1)
    },
    usingRate(data){
        ...
        tooltip: {
          ...
          formatter:function(params){
            ...
            return `起重机租赁价格${qidongji[params[0].dataIndex]}<br />
                    起重机公司价格${qiCompanyPrice}<br />
                    起重机集团价格${qiGroupPrice}<br />
                    挖掘机租赁价格${wajueji[params[0].dataIndex]}<br />
                    挖掘机公司价格${wajiCompanyPrice1}<br />
                    挖掘机公司价格${wajiGroupPrice1}<br />`
          }
