  ...
  methods: {
    ...
    echarts_economy(){
      ...
      var option = {
        ...
        // color: ["#2f89cf", "#27d08a", "#0fa0d6", "#e62d2d" ],
        legend: {
            show:true,
            textStyle: {
              color: "rgba(255,255,255,.6)",
      ...
      var option = {
        ...
        legend: {
          ...
          formatter: function(params) {
            ...
            return params === "月计划" ? `${params}:${parseInt(finished)}` : "";
          }
        },
        series: [
          {
    ...
    echarts_32(monthly) {
      ...
      var option = {
        ...
        legend: {
          ...
          selectedMode: false,
          formatter: function(params) {
            return params === "年计划" ? `${params}:${parseInt(finished)}` : "";
          }
        },
        series: [
          {
    ...
    echarts_33(monthly) {
      ...
      var option = {
        ...
        legend: {
          ...
          selectedMode: false,
          formatter: function(params) {
            return params === "总产值" ? `${params}:${parseInt(finished)}` : "";
          }
        },
        series: [
          {
