      ...
      >
        ...
        <el-table-column prop="earlyWarningLevel" label="预警等级" min-width="120">
          <template slot-scope="scope">
            ...
            <span v-if="scope.row.earlyWarningLevel === '红色'"><el-tag type="danger">红色</el-tag></span>
            <span v-if="scope.row.earlyWarningLevel === '橙色'"><el-tag type="warning">橙色</el-tag></span>
            <span v-if="scope.row.earlyWarningLevel === '黄色'">长久闲置</span>
          </template> 
        </el-table-column>
