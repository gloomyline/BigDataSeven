  ...
  <div class="labourServices">
    ...
    <div class="container">
      ...
      <div class="partWrapper">
        ...
        <div class="contentWrapper">
            <div class="chartcont">
              <div style="position:absolute;right:0;z-index:99999"><el-button type="primary"  @click.native="labourwhole">七公司</el-button></div>
              <div class="map" id="labourusage" style="margin-top:.3rem"></div>
              <div class="describe">{{conStatistics}}</div>
  ...
  methods: {
   ...
   handleRowChange2(row){
    ...
    async fetchconStatistics(){
       let res = await LabourServicesNewApi.fetchconStatistics();
       this.conStatistics=res.conStatistics
    },
    // 劳务队伍作业人数占比
...
.el-button--primary {
    color: #FFF;
    background-color: rgba(75,143,211,.5);
    border-color: rgba(75,143,211,.5);
}
</style>
