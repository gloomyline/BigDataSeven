  ...
  <div class="labourServices">
    ...
    <div class="container">
      ...
      <div class="partWrapper">
        ...
        <div class="contentWrapper">
            <div class="chartcont">
              <div style="position:absolute;right:0;z-index:99"><el-button type="primary"  @click.native="fetchLabourusagedetaiData">七公司</el-button></div>
  ...
  methods: {
   ...
   handleRowChange2(row){
    ...
    async fetchLabourusagedetaiData(){
      let arr = await LabourServicesNewApi.fetchLabourusagedetailData(this.date,"")
      this.LabourusagedetailData = arr.data
      console.log("fetchLabourusagedetailData",this.LabourusagedetailData)
    },
    //七公司
