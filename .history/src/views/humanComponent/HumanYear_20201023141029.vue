    ...
    drawYearChart(data) {
      ...
      for (let key in data){
        console.log("ddaa``````",data)
          ...
          lessThan.push(data[key]["姓名"]["lessThan"])
          lessAmong.push(data[key]["姓名"]["lessAmong"])
          greaterAmong.push(data[key]["姓名"]["greaterAmong"])
          greaterThan.push(data[key]["姓名"]["greaterThan"])
