...
export default {
  ...
  data() {
    return {
      ...
      iscur: 0,
      // tabs: [{ name: "组织机构" }, { name: "人员情况" }, { name: "薪酬情况" }, { name: "资质证书" },{name:"年度绩效"}],
      tabs: [{ name: "组织机构" }, { name: "人员情况" }, { name: "薪酬情况" }, { name: "资质证书" }],
      // componentsList: ["humanOrganNew", "humanStatus", "humanFun", "humanCre","humanYear"],
