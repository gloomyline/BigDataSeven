<template>
  <div class="labourServices">
    ...
    <div>
      ...
      <keep-alive>
        <component :is="currentComponent" :date="date"></component>
      </keep-alive>
    </div>
    <!-- <dv-border-box-10>
    <div class="container">
      ...
      <div class="partWrapper">
        ...
        <div class="contentWrapper">
            <div class="chartcont">
				<div class="map" id="labourusage"></div>
			</div>
            <div class="tablecont">
				<div id="app_labourusage_head" 
					 style="width: 100%;
						height: 37px;
...
import AccountManagement from '@/views/labourServices/AccountManagement';
import IntegratedManagement from '@/views/labourServices/IntegratedManagement';
export default {
  components: { AccountManagement, IntegratedManagement },
  data() {
    return {
      current: 0,
      tabs: ['综合管理', '台帐管理' ],
      currentComponent: 'IntegratedManagement',
      componentList: ['IntegratedManagement', 'AccountManagement'],
      tableData: [],
      tableData2: [],
      // LabourusageData:[],
