  ...
  <div class="engineering">
    ...
    <div class="table boxall">
      ...
      >
        ...
        <el-table-column prop="earlyWarningLevel" label="预警等级" min-width="120"></el-table-column>
    ...
    ajaxData(){
     ...
     tableRowClassName({row, rowIndex}) {
      ...
      if(row.earlyWarningLevel){
        ...
        }else if(row.usingState=="橙色"){
            return "textcolorOrage"
        }else if(row.usingState=="黄色"){
