...
export default {
  ...
  methods: {
    ...
    income(data){
      ...
      this.drawChart("income",xAxisdata,target,finish,finishingRate)
    },
    drop(data){
      // 两金压降
      var xAxisdata = []
      ...
      this.drawChart("drop",xAxisdata,target,finish,finishingRate)
    },
    profit(data){
      // 净利润 
      var xAxisdata = []
      ...
      this.drawChart("profit",xAxisdata,target,finish,finishingRate)
    },
    cashflow(data){
      // 经营性现金流
      var xAxisdata = []
      ...
      this.drawChart("cashflow",xAxisdata,target,finish,finishingRate)
    },
    drawChart(id,xAxisdata,target,finish,finishingRate){
