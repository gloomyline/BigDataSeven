...
export default {
  ...
  methods: {
    ...
    profit(data){
      ...
      this.drawChart2("profit",xAxisdata,target,finish,finishingRate,deptId)
    },
    cashflow(data){
      // 经营性现金流
       var deptId =[]
      ...
      this.drawChart2("cashflow",xAxisdata,target,finish,finishingRate,deptId)
    },
    drawChart(id,xAxisdata,target,finish,finishingRate,deptId){
      ...
      var option = {
        ...
        yAxis: [
        {
          ...
          //   if(value.min<0){
          //     y1interval = value.max-value.min
          //   }else{
          //     y1interval = value.max
          //   }

          //   console.log("y1interval",y1interval)
          //   return `${value.min}`
            
          // },
          
          //  interval: y1interval / 6
          // interval: 3
        },
        {
          type:'value',
          ...
          splitNumber:5,
          min:function(value){
            console.log("111this",this)
            console.log("value2",value)
            if(value.min<0){
              y2interval = value.max-value.min
              
            }else{
              y2interval = value.max
            }
            console.log("y2interval",y2interval)
            return `${value.min}`
          },
          
          //  interval: y2interval / 6
        }
      ],
        series: [
          {
    ...
    drawChart2(id,xAxisdata,target,finish,finishingRate,deptId){
      var _this = this
