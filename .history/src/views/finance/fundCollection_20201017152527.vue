<template>
  <div class="finance">
    <dv-border-box-10 class="chartContainer">
      <div class="chartTitle">回款率</div>
      <div id="returnRate" class="chartContent" ></div>
    </dv-border-box-10>
    <dv-border-box-10 class="chartContainer">
      <div class="chartTitle">上缴率</div>
      <div id="turnInRate" class="chartContent" ></div>
    </dv-border-box-10>
    <dv-border-box-10 class="chartContainer">
      <div class="chartTitle">资金集中率</div>
  ...
  methods:{
    initData(){
      ...
      response.map((item)=>{
        ...
        this.returnRateData.push(item.company)
        this.turnInRateData.push(item.company)
        this.capitalRateData.push(item.company)
      })
    ...
    returnRate(){
      ...
      this.drawChart("returnRate",xAxisdata,seriesdata)
    },
    turnInRate(){
      // 上缴率
      var xAxisdata = ["湖北分公司","华北分公司","城轨分公司","房建分公司","西北分公司","武汉分公司","独立项目","海南项目群"]
      var seriesdata = [60, 20, 86, 60, 80, 20,45,35,88] 
      this.drawChart("turnInRate",xAxisdata,seriesdata)
    },
    capitalRate(){
      // 资金集中率
      var xAxisdata = ["湖北分公司","华北分公司","城轨分公司","房建分公司","西北分公司","武汉分公司","独立项目","海南项目群"]
      var seriesdata = [60, 20, 86, 60, 80, 20,45,35,88] 
      this.drawChart("capitalRate",xAxisdata,seriesdata)
    },
