...
export default {
  ...
  methods: {
    ...
    async getData(){
      console.log("this.$router",this.$router.params.deptId)
      console.log("this.$router",this.$router.params.month)
      var res = await LabourServicesNewApi.fetchfindSubcons(this.ny,96)
    },
    goto(idx) {
      const routeMap = [
        {
