  ...
  methods: {
    ...
    async finishlmonth() {
      ...
      if(res && res.data) {
        ...
        this.echarts_32(res.data.yearly.finished, res.data.yearly.remained,res.data.monthly.planed)
        this.echarts_33(res.data.sofar.finished, res.data.sofar.remained,res.data.monthly.planed)
      } else {
