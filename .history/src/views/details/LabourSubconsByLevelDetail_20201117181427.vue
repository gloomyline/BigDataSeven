...
export default {
  ...
  methods:{
    async initData(){
      var res = await LabourServicesNewApi.fetchfindAllSubconsByLevel(this.currentPage,this.level,this.pageSize,)
    ...
    handleCurrentChange(val) {
        ...
        LabourServicesNewApi.fetchfindAllSubconsByLevel(this.currentPage,this.pageSize).then((data)=>{
