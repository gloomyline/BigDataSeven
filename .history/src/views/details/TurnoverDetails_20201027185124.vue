...
export default {
  ...
  methods: {
    ...
    buildParam(oldparam){
        return oldparam.deptId==null ? oldparam.id:oldparam.deptId
    },
    goto(idx) {
      const routeMap = [
        {
          name: 'DispatchNew',
          params: {id: buildParam(this.$route.params).deptId, name: this.$route.params.name, ny: this.$route.params.ny},
        },
        {
          name: 'TurnoverDetails',
