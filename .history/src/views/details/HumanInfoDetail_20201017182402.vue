    ...
    async dispatchHumanDetail(){
      ...
      if(res){
        ...
        for (var i=0;i<deptNameArr.length;i++){
          ...
          var childrenlist = res.map((item)=>{
            return item.deptName == deptNameArr[i].deptName
          })
          var temp = {
            id:null,
            deptName:deptNameArr[i].deptName,
            deputyChief:null,
            first:null ,
            headcount: null,
            id: null,
          ...
          HumanDetailData.push(temp)



        }
        console.log("HumanDetailData",HumanDetailData)
