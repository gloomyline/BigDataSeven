      ...
      <div class="partWrapper">
        ...
        <div class="contentWrapper">
            <div class="chartcont">
              ...
              <div class="describe">公司现有注册劳务企业 <a >{{conStatistics.regist}} </a>  家，在用劳务企业 <a >{{conStatistics.using}}  </a >家。A级企业{{conStatistics.A}}6家，B级企业 <a >{{conStatistics.B}} </a >家，C级企业{{conStatistics.C}}家，D级企业{{conStatistics.D}}家，不合格劳务企业{{conStatistics.E}}家</div>
