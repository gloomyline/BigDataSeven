      ...
      <div class="partWrapper">
        ...
        <div class="contentWrapper">
            <div class="chartcont">
              ...
              <div class="describe">公司现有注册劳务企业 <a >{{conStatistics.regist}} </a>  家，在用劳务企业 <a >{{conStatistics.using}}  </a >家。A级企业 <a >{{conStatistics.A}} <a >6家，B级企业 <a >{{conStatistics.B}} </a >家，C级企业  <a >{{conStatistics.C}} </a >家，D级企业 <a >{{conStatistics.D}} </a >家，不合格劳务企业 <a >{{conStatistics.E}}家 </a ></div>
