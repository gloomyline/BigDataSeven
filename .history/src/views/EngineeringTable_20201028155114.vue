  ...
  <div class="engineering">
    ...
    <div class="table boxall">
      ...
      >
        ...
        <el-table-column prop="earlyWarningLevel" label="预警等级"></el-table-column>
    ...
    <div class="table boxall">
      ...
      >
        ...
        <el-table-column prop="profitEarlywarning" label="利润额预警等级" ></el-table-column>
        <el-table-column prop="zrCost" label="责任成本盈亏" ></el-table-column>
        <el-table-column prop="zrCostSectionExcessRate" label="责任成本节超率" ></el-table-column>
        <el-table-column prop="zrjcEarlywarning" label="责任成本节超率预警等级" ></el-table-column>
      </el-table>
      <div class="boxfoot"></div>
    </div>
