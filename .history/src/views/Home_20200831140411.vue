  ...
  methods: {
    ...
    echarts_finance1(){
      ...
      for (var item in planMapData ){
		...
		compalist.push(planMapData[item].total > planMapData[item].completed ?planMapData[item].total :planMapData[item].completed)
      ...
      var option = {
        ...
        color: ["rgb(2,2,2,0)", "#27d08a", "#e62d2d", "#0fa0d6", "#0fb4d6"],
        grid: {
          top:'20%',
          left: '5%',
          right: '5%',
        ...
        series: [
         {
             ...
             label:{
              ...
              formatter: function(params) {
               ...
               return `${total[params.dataIndex]}亿元`
              }
             },
             barWidth : 30
    ...
    echarts_finance2(){
      ...
      for (var item in profitMapData ){
        ...
        compalist.push(profitMapData[item].total > profitMapData[item].completed ?profitMapData[item].total :profitMapData[item].completed)
       }
        ...
        series: [
         {
             ...
             label:{
              ...
              formatter: function(params) {
               //  console.log("我的参数",params)
      			   console.log("total[params.params]",params)
               return `${total[params.dataIndex]}万元`
              }
             },
             barWidth : 30
