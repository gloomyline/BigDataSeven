    ...
    <div>
      <div class="chartContainerFather">
        ...
        <dv-border-box-10 class="chartContainer">
          <div class="title"></div>
          <div class="content2">
            <div class="echartwrapper" id="earing">asdfasdf</div>
            <div class="echartwrapper" id="profit">cccc</div>
          </div>
        </dv-border-box-10>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    financeValuation(){
      console.log("项目计价回款",this.financeValuationData.data)
    ...
    financeProfit(){
      ...
      let id="profit"
      let xData=[]
      let legendData=['营业利润','货币存量']
      let profitData=[]
      let monetaryData=[]
      let yTitle="十三五规划对比图 (单位:万元)"
      let unit = ""
      for(var i in profit){
    ...
    drawEcharsLine(id, xData, legendData, seriesData, yTitle,unit){
      ...
      var option = {
        ...
        color: ["#0fa0d6", "#0fb4d6","#2f89cf", "#27d08a", "#e62d2d"],
        tooltip: {
          trigger: 'axis',
          // axisPointer: {            // 坐标轴指示器，坐标轴触发有效
          //  type: 'shadow'        // 默认为直线，可选为：'line' | 'shadow'
