    ...
    drawHumanDetails() {
      ...
      const option = {
        ...
        xAxis: [
          {
            type: "category",
            data: ["安九铁路项目一", "安九铁路项目二", "安九铁路项目三", "项目四", "项目五", "项目六"],
            axisLabel: {
              textStyle: {
